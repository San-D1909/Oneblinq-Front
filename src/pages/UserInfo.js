...
export class UserInfo extends Component {
  ...
  OnLoad = (e) => {
    ...
    axios({
      ...
      self.setState({ userData: data.data.userById }, () => {
        console.log(self.state.userData);
      });
      self.setState({ companyData: data.data.userCompany }, () => {
        console.log(self.state.companyData);
      });
    });
  };
  ...
  render() {
    ...
    return (
      <body>
        ...
        <div
          class="card mx-auto"
          style={{ backgroundColor: "white", maxWidth: "60%" }}
        >
          <div class="card-body">
            <h4
            ...
            <h6 style={{ textAlign: "center" }}>
              You can update your user information in the fields below.
            </h6>
            <hr class="solid"></hr>
            <div className="py-2">
            ...
            <Button
              className="my-2 mr-2 ml-0 loginbutton"
